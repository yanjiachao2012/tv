<template>
	<el-dialog :visible.sync="dialogVisible" class="dialog-container" @close='close' width="600px" center :show-close="false">
	  ...
	  <div slot="footer" class="dialog-footer">
	  	...
	  	<div v-if="removeBox">
	  		<el-button class="sure-button" type="primary" @click="sureBtn">确定</el-button>
